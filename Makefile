...
#    Updated: 2020/07/10 18:14:22 by bdrinkin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
builds:
	@gcc -Wall -Wextra -Werror -Iincludes -IallLibs/libft/includes -I../SDL2-2.0.12/build/static_lib/include/SDL2 -LallLibs/libft -lft -L../SDL2-2.0.12/build/static_lib/lib -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf src/*.c -o wolf3d
