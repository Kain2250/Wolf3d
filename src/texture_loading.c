...
/*   Updated: 2020/08/04 15:42:17 by mcarc            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_textures(SDL_Texture **textures, SDL_Renderer *render)
{
	...
	textures[texture_steel_panel_n] = IMG_LoadTexture(render, TEX_STEEL_PANEL_N);
	textures[texture_steel_panel_s] = IMG_LoadTexture(render, TEX_STEEL_PANEL_S);
	textures[texture_steel_panel_e] = IMG_LoadTexture(render, TEX_STEEL_PANEL_E);
	textures[texture_steel_panel_w] = IMG_LoadTexture(render, TEX_STEEL_PANEL_W);
